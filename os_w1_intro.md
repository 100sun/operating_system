...
Priority Scheduling: FCFS, SJF, HRN, [static, dynamic]()
...
* time until started - arrived time
...
* time until turned around - arrived time

### by algorithms

|process|arrive time|execution time|
|---|---|---|
|P1|0|20|
|P2|1|14|
|P3|2|8|
...
|priority|waiting_time↓|run_time↓|(waiting_time/run_time)+1↓|remained run_time↓||
|disadvs|low efficiency<Br/>∵convoy effect(AWT⇑)|starvation<br/>∵when the first process takes too long|cannot resolve starvation still...|same problem w/SJF + context switching |
|AWT|
|ATT|
